...
\restrict ptg5jdGMO6jxW0etZ62hBtHgX5ZtKTFvDd5o4B03TnhA7wrKcAVRorav3Yf9mh6
...
CREATE TABLE public.invoices (
    ...
    cgst bigint,
    sgst bigint,
    CONSTRAINT invoices_payment_method_check CHECK ((payment_method = ANY (ARRAY['Cash'::text, 'UPI'::text, 'Card'::text, 'Credit'::text]))),
    CONSTRAINT invoices_payment_status_check CHECK ((payment_status = ANY (ARRAY['Paid'::text, 'Unpaid'::text, 'Partial'::text])))
);
...
CREATE TABLE public.products (
    ...
    created_at timestamp with time zone DEFAULT now(),
    CONSTRAINT products_unit_type_check CHECK ((unit_type = ANY (ARRAY['pcs'::text, 'kg'::text, 'pkt'::text])))
);


--
-- Name: store_details; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.store_details (
    ...
    phone_number text,
    address1 text,
    default_cgst_percent numeric(5,2) DEFAULT 2.5,
    default_sgst_percent numeric(5,2) DEFAULT 2.5,
...
--
-- Name: store_details store_details_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.store_details
    ADD CONSTRAINT store_details_pkey PRIMARY KEY (id);
...
--
-- Name: SEQUENCE invoices_invoice_no_seq; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON SEQUENCE public.invoices_invoice_no_seq TO anon;
GRANT ALL ON SEQUENCE public.invoices_invoice_no_seq TO authenticated;
...
--
-- Name: TABLE store_details; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.store_details TO anon;
GRANT ALL ON TABLE public.store_details TO authenticated;
GRANT ALL ON TABLE public.store_details TO service_role;
...
\unrestrict ptg5jdGMO6jxW0etZ62hBtHgX5ZtKTFvDd5o4B03TnhA7wrKcAVRorav3Yf9mh6
